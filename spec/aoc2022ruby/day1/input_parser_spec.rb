...
RSpec.describe Day1::InputParser do
  let(:input_file_path) { "spec/fixtures/day1/input.txt" }
  ...
  context "when the last line is empty" do
    let(:input_file_path) { "spec/fixtures/day1/last_line_empty.txt" }

    include_examples "yields consecutive lines"
  end

  context "when the first line is empty" do
    let(:input_file_path) { "spec/fixtures/day1/first_line_empty.txt" }
